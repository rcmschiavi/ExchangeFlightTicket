...
### How to
1. Step one: download the program:
...
If you had some problems like the program closing, maybe you openned the excel file while the search was running or the internet connection is not good.

## Final thoughts

This was a project especific and hurried project, so may doesn't satisfy your needs, but if you're a programmer you can easily make some changes.

If you find some bugs, please contact me. Or if you're a programmer, you can fix for me ;)
